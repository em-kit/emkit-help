...
The Slack integration is used exclusively by the [EM Kit Copilot](/guides/em-copilot/). Once configured, the Copilot can reach into your Slack workspace through MCP to pull channel context, search messages, and help you draft replies.
