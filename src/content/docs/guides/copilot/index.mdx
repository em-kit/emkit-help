...
EM Kit tracks the token usage of every AI action and turns it into an estimated cost, with an optional hard monthly budget that blocks new AI calls once reached. See [Usage & Cost](/guides/copilot/usage-cost/) for the full breakdown.
