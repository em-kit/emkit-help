...
|---|---|---|
| "…did not respond within 600s" | Wall-clock timeout hit. | Shorten the prompt, lower reasoning effort, or check that the provider CLI isn't waiting for login. See [EM Copilot troubleshooting](/guides/em-copilot/#claude-code-did-not-respond-within-600s) for the full checklist. |
