...
import CreatePIPImage from '@assets/screenshots/emkit-create-pip.png';
import PIPImage from '@assets/screenshots/emkit-pip.png';
...
Go to **My Team → Member → Performance Reviews**, then scroll to the **Personal Improvement Plans** section.
