...
The EM Kit MCP server currently exposes read-only tools for:

- Listing workspaces
- Getting a workspace summary
- Listing team members
- Listing manager tasks
- Listing feedback to share
- Listing daily notes
- Listing work log entries
- Getting the latest review period

Because these tools are read-only, this setup is safer than exposing the full CLI or raw SQL commands to your agent.
...
```text
Use the EM Kit MCP tools to inspect my workspace and summarize open manager tasks and pending feedback.
```
